-- ============================================
-- DIAGNOSTIC QUERY TO CHECK MISSING MIGRATIONS
...
-- HOW TO READ RESULTS:
-- ============================================
-- If "exists" = false, you need to run that migration file
-- If "exists" = true, that migration was already applied
-- 
-- Run missing migrations in numerical order:
