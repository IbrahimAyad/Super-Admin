-- =====================================================
-- FINAL FIX FOR DASHBOARD - COMPLETE VERSION
-- This script handles all missing columns and tables
-- =====================================================

-- 1. First check and add missing columns to orders table if needed
DO $$ 
BEGIN
...
-- 8. Create SIMPLIFIED get_recent_orders function (without missing columns)
...
BEGIN
  ...
  WHERE i.id IS NULL  -- Only products without inventory records
