/**
 * FIXED ENHANCED CUSTOMER IMPORT SCRIPT
 * Handles the name column properly - builds it from first_name + last_name
 * Run with: node scripts/import-enhanced-customers-fixed.js
 */
  ...
  for (const record of records) {
    try {
      ...
      const customerData = {
        ...
        name: fullName,  // Combined name field
