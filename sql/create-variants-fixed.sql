...
-- Fixed: Removed color_name and color_family from products table sync

-- First, check what columns actually exist in products table
-- Then sync only matching columns from products_enhanced

-- Sync products from products_enhanced (only columns that exist)
